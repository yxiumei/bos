  ...
  <TR>
    <TD vAlign=top height=270>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
        ...
        <TR>
          <TD>
            <P><FONT color=#000000><BR>　　你的权限不够，请联系管理员...</FONT>! 
...
width=7></TD>
          <TD background=images/bg.gif>
            ...
            href="${pageContext.request.contextPath }/index.jsp" target="parent">返回首页</A>　 　|　　 <A 
            href="javascript:history.go(-1)">返回出错页</A>　 　|　　 <A 
            href="#" onclick="window.opener=null;window.close()">关闭本页</A></FONT> </DIV></TD>
          <TD width=7><IMG 
