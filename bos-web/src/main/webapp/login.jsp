...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform1" name="loginform" method="post" class="niceform"
					action="UserAction_login">
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						style="margin-top: 5px;">
						<input id="loginform:idInput" type="text" name="username"
							class="loginFormTdIpt" maxlength="50" value="${param.username }"/>
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a onclick="document.getElementById('loginform1').submit();" href="javascript:void(0)" id="loginform:j_id19" name="loginform:j_id19">
						<span
